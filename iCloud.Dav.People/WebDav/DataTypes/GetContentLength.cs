...
namespace iCloud.Dav.Core.WebDav.Card
{
    ...
    internal class GetContentLength : IXmlSerializable
    {
        ...
        /// <summary>
        /// Gets or sets the value of the getcontentlength.
        /// </summary>
        ...
        {
            if (!reader.IsStartElement("getcontentlength", "DAV:")) return;
        ...
        {
            writer.WriteElementString("getcontentlength", "DAV:", Value);
        }
