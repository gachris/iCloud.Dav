...
// #1 Use the contact's 'Id' property, not the 'Uid' property, when interacting with requests.
ContactList contactList = peopleService.People.MultiGet(identityCard.ResourceName, new string[] { "contact.Id-1", "contact.Id-2" }).Execute();