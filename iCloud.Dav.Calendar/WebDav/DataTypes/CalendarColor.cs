...
namespace iCloud.Dav.Core.WebDav.Cal
{
    ...
    internal class CalendarColor : IXmlSerializable
    {
        ...
        /// <summary>
        /// Gets or sets the value of the calendar-color.
        /// </summary>
        ...
        {
            if (!reader.IsStartElement("calendar-color", "http://apple.com/ns/ical/")) return;
        ...
        {
            writer.WriteElementString("calendar-color", "http://apple.com/ns/ical/", Value);
        }
