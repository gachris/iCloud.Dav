...
namespace iCloud.Dav.People.CardDav.Types
{
    ...
    internal sealed class MultiStatus : IXmlSerializable
    {
        ...
        private static Response GetResponse(XElement xResponse)
        {
            ...
            var me_cardAttribute = !(me_card is null) ? new Attribute(me_card.Name.LocalName,
            ...
            var address_dataAttribute = !(address_data is null) ? new Attribute(address_data.Name.LocalName,
                                                                                 address_data.Name.NamespaceName,
                                                                                 address_data.Value) : null;

            return new Response(href?.Value,
                       status?.Value,
                       length,
                       getetag?.Value,
                       getctagAttribute,
